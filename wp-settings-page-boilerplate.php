 ...
 *
 * @wordpress-plugin
 * Plugin Name:       WP Settings Page Boilerplate
 * Plugin URI:        https://giuliodaprela.com
 * Description:       A collection of snippets to build settings pages more rapidly.
 * Version:           1.0.0
 * Author:            Giulio Daprela
 * Author URI:        https://giuliodaprela.com
 * License:           GPL-2.0+
 * License URI:       http://www.gnu.org/licenses/gpl-2.0.txt
 * Text Domain:       dapre-wpspb
 * Domain Path:       /languages
 */

namespace dapre_wpspb;

use dapre_wpspb\includes;
